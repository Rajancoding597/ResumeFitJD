...
public class GeminiResumeRewriterClient implements ResumeRewriterClient {
    ...
    public GeminiResumeRewriterClient(GeminiProperties properties, ObjectMapper objectMapper) {
    ...
    private ResponseStatusException buildGeminiException(String responseBody, int statusCode) {
        ...
        return new ResponseStatusException(mappedStatus, extractErrorMessage(responseBody));
    }
    ...
    private String extractErrorMessage(String responseBody) {
        ...
        return "Gemini request failed with an upstream error.";
    }
}
